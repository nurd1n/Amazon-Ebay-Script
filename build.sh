...
echo "echo \"\$(wp post get $(cat /home/ebay/attachment/deleteidpost.txt) --field=guid --allow-root)/\$(wp post get $(cat /home/ebay/attachment/deleteid.txt) --field=post_name --allow-root)\" > /home/ebay/attachment/deleteurlattachment.txt" | bash -
cd /home/ebay/attachment
# sitemap
